...
class FlappyBird():
    def __init__(self):
        ...
        self.icon = pygame.image.load("favicon.ico")
        ...
        self.gravity = 0.25
        self.move = 0
        self.bg_image = pygame.image.load("background-day.png")  # Bg image
        self.bg_image = pygame.transform.scale(self.bg_image, (self.width, self.height))
        self.base_image = pygame.image.load("base.png")
        self.game_over = pygame.image.load("gameover.png")
        self.down = pygame.image.load("yellowbird-downflap.png")  # Bird animations
        self.mid = pygame.image.load("yellowbird-midflap.png")
        self.up = pygame.image.load("yellowbird-upflap.png")
